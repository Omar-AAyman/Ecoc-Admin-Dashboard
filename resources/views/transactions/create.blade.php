        ...
        <div class="inner-body">
            ...
            <form action="{{ route('transactions.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6" id="charge_permit_number_field" style="display: none;">
                ...
                <div class="row mb-3" id="discharge_permit_number_field" style="display: none;">
                    <div class="col-md-6">
                ...
                <div class="row mb-3" id="charge_permit_document_field" style="display: none;">
                    <div class="col-md-6">
                ...
                <div class="row mb-3" id="discharge_permit_document_field" style="display: none;">
                    <div class="col-md-6">
                ...
                <div id="shipment_details" style="display: none;">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6" id="shipment_vessel_id_field" style="display: none;">
                ...
                <div id="delivery_details" style="display: none;">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6" id="delivery_vessel_id_field" style="display: none;">
