                ...
                <div class="container">
                    <div class="d-flex justify-content-between align-items-center">
                        <h2 class="my-3 my-md-0">
                            <i class="fas fa-exchange-alt me-2"></i>Edit Transaction
                        </h2>
                                ...
                                <div class="transaction-type-container">
                                    <div style="flex-grow: 1;">
                                        ...
                                        <select name="type" id="type" class="form-select" required>
                                            ...
                                            <option value="loading" {{ $transaction->type == 'loading' ? 'selected' : '' }}>Loading</option>
                                            <option value="discharging" {{ $transaction->type == 'discharging' ? 'selected' : '' }}>Discharging</option>
                                    ...
                                    <img id="company-logo" src="{{ $transaction->company && $transaction->company->logo_url ? $transaction->company->logo_url : '' }}" alt="Company Logo" class="company-logo" style="{{ $transaction->company && $transaction->company->logo_url ? 'display: inline;' : 'display: none;' }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-field" style="display: none;">
                            ...
                            <div class="row mb-3">
                                <div class="col-12 col-md-6 mb-3 mb-md-0">
                                    ...
                                    <select name="tank_id" id="tank_id" class="form-select" required>
                                        ...
                                        <option value="{{ $tank->id }}" {{ $transaction->tank_id == $tank->id ? 'selected' : '' }}>{{ $tank->number }}</option>
                                        @endforeach
                                    </select>
                                    @error('tank_id')
                                    <div class="text-danger">{{ $message }}</div>
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <select name="original_vessel_id" id="original_vessel_id" class="form-select">
                                        ...
                                        <option value="{{ $vessel->id }}" {{ $transaction->original_vessel_id == $vessel->id ? 'selected' : '' }}>{{ $vessel->name }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row mb-3">
                                <div class="col-12 col-md-6 mb-3 mb-md-0">
                                    ...
                                    <input type="text" id="company_name" class="form-control" value="{{ $transaction->company ? $transaction->company->name : '' }}" disabled>
                                    @error('company_name')
                                    <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-12 col-md-6">
                                    ...
                                    <input type="text" id="product_name" class="form-control" value="{{ $transaction->product ? $transaction->product->name : '' }}" disabled>
                                    @error('product_name')
                                    <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <input type="datetime-local" name="date" id="date" class="form-control" value="{{ $transaction->date->format('Y-m-d\TH:i') }}" required>
                                    @error('date')
                                    <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-12 col-md-6 mb-3 mb-md-0">
                                    ...
                                    <select name="shipment[transport_type]" id="shipment_transport_type" class="form-select">
                                        ...
                                        <option value="truck" {{ $transaction->shipment && $transaction->shipment->transport_type == 'truck' ? 'selected' : '' }}>Truck</option>
                                    </select>
                                ...
                                <div class="col-12 col-md-6" id="shipment_vessel_id_field" style="display: none;">
                                    ...
                                    <select name="shipment[vessel_id]" id="shipment_vessel_id" class="form-select">
                                        ...
                                        @foreach($vessels as $vessel)
                                        <option value="{{ $vessel->id }}" {{ $transaction->shipment && $transaction->shipment->vessel_id == $vessel->id ? 'selected' : '' }}>{{ $vessel->name }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="row mb-3">
                                    <div class="col-12 col-md-6 mb-3 mb-md-0">
                                        ...
                                        <select name="shipment[truck_number]" id="shipment_truck_number" class="form-select">
                                            ...
                                            <option value="{{ $truck->truck_number }}" {{ $transaction->shipment && $transaction->shipment->truck_number == $truck->truck_number ? 'selected' : '' }}>{{ $truck->truck_number }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-12 col-md-6">
                                        ...
                                        <select name="shipment[trailer_number]" id="shipment_trailer_number" class="form-select">
                                            ...
                                            <option value="{{ $trailer->trailer_number }}" {{ $transaction->shipment && $transaction->shipment->trailer_number == $trailer->trailer_number ? 'selected' : '' }}>{{ $trailer->trailer_number }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="row mb-3">
                                    <div class="col-12 col-md-6">
                                        ...
                                        <select name="shipment[driver_name]" id="shipment_driver_name" class="form-select">
                                            ...
                                            <option value="{{ $driver->name }}" {{ $transaction->shipment && $transaction->shipment->driver_name == $driver->name ? 'selected' : '' }}>{{ $driver->name }}</option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="row mb-3">
                                <div class="col-12 col-md-6 mb-3 mb-md-0">
                                    ...
                                    <select name="delivery[transport_type]" id="delivery_transport_type" class="form-select">
                                        ...
                                        <option value="truck" {{ $transaction->delivery && $transaction->delivery->transport_type == 'truck' ? 'selected' : '' }}>Truck</option>
                                    </select>
                                ...
                                <div class="col-12 col-md-6" id="delivery_vessel_id_field" style="display: none;">
                                    ...
                                    <select name="delivery[vessel_id]" id="delivery_vessel_id" class="form-select">
                                        <option value="">Select Vessel</option>
                                        @foreach($vessels as $vessel)
                                        <option value="{{ $vessel->id }}" {{ $transaction->delivery && $transaction->delivery->vessel_id == $vessel->id ? 'selected' : '' }}>{{ $vessel->name }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="row mb-3">
                                    <div class="col-12 col-md-6 mb-3 mb-md-0">
                                        ...
                                        <select name="delivery[truck_number]" id="delivery_truck_number" class="form-select">
                                            <option value="">Select Truck</option>
                                            @foreach($trucks as $truck)
                                            <option value="{{ $truck->truck_number }}" {{ $transaction->delivery && $transaction->delivery->truck_number == $truck->truck_number ? 'selected' : '' }}>{{ $truck->truck_number }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="row mb-3">
                                    <div class="col-12 col-md-6">
                                        ...
                                        <select name="delivery[driver_name]" id="delivery_driver_name" class="form-select">
                                            <option value="">Select Driver</option>
                                            @foreach($drivers as $driver)
                                            <option value="{{ $driver->name }}" {{ $transaction->delivery && $transaction->delivery->driver_name == $driver->name ? 'selected' : '' }}>{{ $driver->name }}</option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="row mb-3">
                                <div class="col-12 col-md-6 mb-3 mb-md-0">
                                    ...
                                    <select name="engineer_id" id="engineer_id" class="form-select">
                                        ...
                                        <option value="{{ $engineer->id }}" {{ $transaction->engineer_id == $engineer->id ? 'selected' : '' }}>{{ $engineer->full_name }}</option>
                                        @endforeach
                                    </select>
                                    @error('engineer_id')
                                    <div class="text-danger">{{ $message }}</div>
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <select name="technician_id" id="technician_id" class="form-select">
                                        ...
                                        <option value="{{ $technician->id }}" {{ $transaction->technician_id == $technician->id ? 'selected' : '' }}>{{ $technician->full_name }}</option>
                                        @endforeach
                                    </select>
                                    @error('technician_id')
                                    <div class="text-danger">{{ $message }}</div>
                        ...
                        <div class="form-field" style="display: none;">
                            ...
                            <div class="row mb-3">
                                <div class="col-12 col-md-6 mb-3 mb-md-0">
                                    ...
                                    <input type="text" name="work_order_number" id="work_order_number" class="form-control" value="{{ $transaction->work_order_number }}">
                            ...
                            <div class="row mb-3">
                                <div class="col-12 col-md-6 mb-3 mb-md-0">
                                    ...
                                    <input type="text" name="customs_release_number" id="customs_release_number" class="form-control" value="{{ $transaction->customs_release_number }}">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const originalTransaction = {
        ...
        destination_tank_id: '{{ $transaction->destination_tank_id ?? null }}',
        quantity: parseFloat('{{ $transaction->quantity }}') || 0
    };

    // Store initial selected tank IDs
    const initialSourceTankId = '{{ $transaction->tank_id }}';
    const initialDestinationTankId = '{{ $transaction->destination_tank_id ?? null }}';
    ...
    const fetchAvailableTanks = debounce(function(type) {
        ...
        const sourceTankId = sourceTankSelect.value || initialSourceTankId;
        ...
        fetch(url, {
            ...
            .then(data => {
                ...
                data.source_tanks.forEach(tank => {
                    ...
                    if (tank.id == initialSourceTankId) {
                ...
                if (type === 'transfer' && data.destination_tanks) {
                    data.destination_tanks.forEach(tank => {
                        ...
                        option.value = tank.id;
                        option.textContent = tank.number;
                        if (tank.id == initialDestinationTankId) {
                            option.selected = true;
                        }
                ...
                if (type === 'transfer' && destinationTankSelect?.value) {
                    fetchTankData(destinationTankSelect.value, false);
                }
            })
            .catch(error => {
    ...
    function fetchTankData(tankId, isSourceTank = true) {
        ...
        if (isSourceTank && tankId === lastSourceTankId) {
            return;
        }
        if (isSourceTank) {
    ...
    function updateQuantityValidation() {
        ...
        let effectiveDestinationFreeSpace = destinationTankData.free_space;

        if (sourceTankSelect.value === originalTransaction.tank_id) {
            if (originalTransaction.type === 'loading') {
                if (sourceTankData.current_level < originalTransaction.quantity) {
                    quantityError.textContent = 'Cannot reverse original loading: Source tank has insufficient product';
                    quantityError.style.display = 'block';
                    quantityInput.setCustomValidity('Invalid tank state');
                    quantityInput.disabled = true;
                    return;
                }
                effectiveSourceLevel -= originalTransaction.quantity;
                effectiveSourceFreeSpace += originalTransaction.quantity;
            } else if (originalTransaction.type === 'discharging') {
                if (sourceTankData.current_level + originalTransaction.quantity > sourceTankData.max_capacity) {
                    quantityError.textContent = 'Cannot reverse original discharging: Source tank would exceed capacity';
                    quantityError.style.display = 'block';
                    quantityInput.setCustomValidity('Invalid tank state');
                    quantityInput.disabled = true;
                    return;
                ...
                if (sourceTankData.current_level + originalTransaction.quantity > sourceTankData.max_capacity) {
                    quantityError.textContent = 'Cannot reverse original transfer: Source tank would exceed capacity';
                    quantityError.style.display = 'block';
                    quantityInput.setCustomValidity('Invalid tank state');
                    quantityInput.disabled = true;
                    return;
        ...
        if (type === 'transfer' && destinationTankSelect?.value === originalTransaction.destination_tank_id) {
            if (originalTransaction.type === 'transfer') {
                if (destinationTankData.current_level < originalTransaction.quantity) {
                    quantityError.textContent = 'Cannot reverse original transfer: Destination tank has insufficient product';
                    quantityError.style.display = 'block';
                    quantityInput.setCustomValidity('Invalid tank state');
                    quantityInput.disabled = true;
                    return;
                }
                effectiveDestinationLevel -= originalTransaction.quantity;
                effectiveDestinationFreeSpace += originalTransaction.quantity;
            }
        }
        ...
        let errorMessage = '';
        if (type === 'loading') {
            maxQuantity = effectiveSourceFreeSpace;
            errorMessage = `Maximum quantity: ${maxQuantity.toFixed(2)} MT (free space after reversal)`;
        } else if (type === 'discharging') {
            maxQuantity = effectiveSourceLevel;
            errorMessage = `Maximum quantity: ${maxQuantity.toFixed(2)} MT (current capacity after reversal)`;
        } else if (type === 'transfer') {
            const sourceMax = effectiveSourceLevel;
            const destMax = destinationTankData.max_capacity > 0 ? effectiveDestinationFreeSpace : Infinity;
            maxQuantity = Math.min(sourceMax, destMax);
            errorMessage = `Maximum quantity: ${maxQuantity.toFixed(2)} MT (limited by ${sourceMax <= destMax ? 'source current capacity' : 'destination free space'} after reversal)`;
        }
        ...
        if (type === 'loading' && currentQuantity > 0) {
            if (effectiveSourceLevel + currentQuantity > sourceTankData.max_capacity) {
                ...
                quantityError.style.display = 'block';
                quantityInput.setCustomValidity('Quantity exceeds capacity');
            }
        } else if (type === 'discharging' && currentQuantity > 0) {
            if (effectiveSourceLevel - currentQuantity < 0) {
                quantityError.textContent = 'Quantity would result in negative source tank level';
                quantityError.style.display = 'block';
                quantityInput.setCustomValidity('Negative tank level');
            }
        } else if (type === 'transfer' && currentQuantity > 0) {
            if (effectiveSourceLevel - currentQuantity < 0) {
                quantityError.textContent = 'Quantity would result in negative source tank level';
                quantityError.style.display = 'block';
                quantityInput.setCustomValidity('Negative tank level');
            } else if (destinationTankData.max_capacity > 0 && effectiveDestinationLevel + currentQuantity > destinationTankData.max_capacity) {
                quantityError.textContent = 'Quantity would exceed destination tank capacity';
                quantityError.style.display = 'block';
                quantityInput.setCustomValidity('Quantity exceeds capacity');
            }
        }
    ...
    form.addEventListener('submit', function(e) {
        ...
        if (sourceTankData.max_capacity === 0) {
            e.preventDefault();
            document.getElementById('quantity-error').textContent = 'Selected tank has no capacity';
