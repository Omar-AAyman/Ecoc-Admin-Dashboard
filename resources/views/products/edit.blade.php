                    ...
                    <form action="{{ route('products.update', $product->id) }}" method="POST">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <input type="number" name="density" id="density" class="form-control @error('density') is-invalid @enderror" value="{{ old('density', $product->density) }}" step="0.001" min="0.1" required>
                                @error('density')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
