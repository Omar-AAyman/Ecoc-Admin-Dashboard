                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="search-container">
                            <input type="text" id="product-search" class="form-control" placeholder="Search by name or density..." value="{{ request('search') }}">
                        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function fetchProducts(search = '', perPage = 10, page = 1) {
        $.ajax({
            ...
            success: function(response) {
                // Update table body
                $('#products-table-body').html(response.table);
    ...
    const debouncedSearch = debounce(function() {
        ...
        fetchProducts(searchTerm, perPage);
    }, 300);
    ...
    document.getElementById('pagination-links').addEventListener('click', function(e) {
        ...
        if (e.target.tagName === 'A' && e.target.getAttribute('href')) {
            ...
            const searchTerm = document.getElementById('product-search').value;
            const perPage = document.getElementById('per-page').value;
            fetchProducts(searchTerm, perPage, page);
        }
    });
