            ...
            <div class="hero-header">
                <div class="container">
                    <h2 class="my-3 my-md-0">
                        <i class="fas fa-trailer me-2"></i>Create Trailer
                    </h2>
                </div>
            </div>
                    ...
                    <form action="{{ route('trailers.store') }}" method="POST">
                        ...
                        <div class="row mb-3">
                            <div class="col-12">
                                ...
                                <input type="text" name="trailer_number" id="trailer_number" class="form-control" value="{{ old('trailer_number') }}" required>
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <a href="{{ route('trailers.index') }}" class="btn btn-secondary">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
