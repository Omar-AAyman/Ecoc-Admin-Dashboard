        ...
        <div class="inner-body">
                ...
                <div class="container">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex gap-2">
                            <a href="{{ route('drivers.create') }}" class="btn btn-primary d-flex align-items-center">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="search-container">
                            <input type="text" id="driver-search" class="form-control" placeholder="Search by driver name..." value="{{ request('search') }}">
                        </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-hover align-middle mb-0" id="drivers-table">
                            <thead>
                                <tr>
                                    <th>Driver Name</th>
                                    <th>Actions</th>
            ...
            <div class="d-flex justify-content-between align-items-center mt-4">
                ...
                <div id="pagination-links">
                    {{ $drivers->appends(request()->all())->links('pagination::bootstrap-5') }}
                </div>
            </div>
            @endif
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function fetchDrivers(search = '', perPage = 10, page = 1) {
        $.ajax({
            ...
            success: function(response) {
                $('#drivers-table-body').html(response.table);
    ...
    function attachDeleteHandlers() {
        document.querySelectorAll('.delete-driver-form').forEach(form => {
            form.addEventListener('submit', function(e) {
                e.preventDefault();
                const driverName = this.querySelector('.delete-btn').dataset.driverName;
    ...
    const debouncedSearch = debounce(function() {
        ...
        fetchDrivers(searchTerm, perPage);
    }, 300);
    ...
    document.getElementById('pagination-links').addEventListener('click', function(e) {
        ...
        if (e.target.tagName === 'A' && e.target.getAttribute('href')) {
            ...
            const searchTerm = document.getElementById('driver-search').value;
            const perPage = document.getElementById('per-page').value;
            fetchDrivers(searchTerm, perPage, page);
        }
    });
